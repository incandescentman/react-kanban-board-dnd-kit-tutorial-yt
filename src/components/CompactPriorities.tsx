...
export default function CompactPriorities({ board, onOpenPriorities }: Props) {
  ...
  return (
    <div className="w-72">
      <div className="relative w-72 bg-gradient-to-br from-blue-50 to-indigo-100 border-2 border-blue-200 rounded-xl pl-4 pr-2 py-4 shadow-md">
        <div className="flex-1 pr-2">
          ...
          <div
            ...
            title="Add priority"
            className="w-full min-h-28 flex-1 cursor-pointer group flex items-center justify-center hover:bg-white/30 rounded-lg transition-colors mt-2"
          >
